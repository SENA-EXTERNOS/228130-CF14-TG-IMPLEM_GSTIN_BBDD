...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.align-items-center.mb-5
      ...
      .col-md-11
        p.mb-0 El termino NoSQL tiene un significado particular, 
          em not only SQL
      ...
      .col-md-8
        AcordionA.mb-5(tipo="a" clase-tarjeta="tarjeta tarjeta--gris")
          ...
          div(titulo="Generalidades")
            p.mb-4 Este tipo de bases de datos no relacional esta ideal para construir aplicaciones modernas, gracias a que está conformada por esquemas flexibles y diseñadas específicamente para modelos de datos especiales. Son reconocidas en el desarrollo de 
              em software 
          ...
          div(titulo="Desventajas de las bases de datos no relacionales (NoSQL)")
            ol
              ...
              li.mb-3
                i.fas.fa-square.cac.me-3
                |Incompatibilidad con consultas SQL; significa que se necita construir su propio lenguaje para ejecutar las diferentes consultas.
              li.mb-3
                i.fas.fa-square.cac.me-3
